...
export async function setup(){
    ...
    }console.log("Usuario cadastrados na API")
...
export default(data) =>{
    ...
    let idUsuario = data[Index]

    const resGetUsuarios = baseRest.get(`${ENDPOINTS.USER_ENDPOINT}/`, idUsuario)
    
    baseChecks.checkStatusCode(resGetUsuarios, 200)
    baseChecks.checkResponseTime(resGetUsuarios, 2000)
    sleep(1)
}
...
export function handleSummary(data) {
    return {
      "stress_test_getUsuario.html": htmlReport(data),
    };
}